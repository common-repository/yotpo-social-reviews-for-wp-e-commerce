...
class Yotpo_Review_Export
{
    ...
    protected function getAllReviews() {   
        ...
        foreach ($results as $value) {
            error_log('hmmm');
            $product_instance = get_post($value->product_id);
            ...
            $current_review['product_description'] = htmlentities($product_instance->post_content);
            $current_review['product_url'] = get_permalink($value->product_id);
            $current_review['product_image_url'] = wpsc_the_product_image('', '', $product->prodid);
